document.addEventListener("DOMContentLoaded", () => {
        ...
        const group =
          createSvg(
            "g",
            {
              class:
                isPeten
                  ? "atlas-department atlas-department-no-coverage"
                  : "atlas-department",
              tabindex:
                isPeten ? "-1" : "0",
              role:
              ...
              "aria-label":
                isPeten
                  ? `Departamento de ${department.name}, sin cobertura activa de SEPRIGUA`
  ...
  /* =======================================================
     ENTRADA ÚNICA DE LA SECCIÓN COBERTURA
     ======================================================= */
  ...
  if (coverageSection) {
    ...
    let coverageEntrancePlayed = false;


    const playCoverageOnce =
      () => {
        if (
          coverageAnimationBusy ||
          coverageEntrancePlayed
        ) {
          return;
        }

        coverageEntrancePlayed = true;
