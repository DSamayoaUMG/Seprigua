document.addEventListener("DOMContentLoaded", () => {
  ...
  */
  ...
  navbar
    .querySelectorAll(".nav-shared-gear, .nav-shared-tuky")
  ...
  */
  ...
  tukyVideo.src =
    "assets/video/tuky-navbar.mp4";

  tukyVideo.autoplay = true;
  tukyVideo.loop = true;
  tukyVideo.muted = true;
  tukyVideo.playsInline = true;
  tukyVideo.preload = "auto";
  tukyVideo.poster = "assets/img/tuky-navbar-fallback.webp";
  ...
  const positionGear = (
    ...
    /* Tuky camina al costado izquierdo de la opción activa. */
    const sideGap = 18;
    const tukyHalf = 24;
    const center =
      Math.max(42,
