(() => {
  ...
  const WORK_META = [
    {
      ...
      description:
        "Solucionamos obstrucciones en drenajes, reposaderas y tuberías mediante procedimientos especializados, ayudando a recuperar el flujo normal y prevenir futuros inconvenientes. Atención profesional y servicio garantizado hasta que el problema quede resuelto."
    },
    {
      title: "Limpieza y mantenimiento de drenajes",
      description:
        "Realizamos limpieza especializada de drenajes y tuberías, eliminando residuos y acumulaciones que dificultan el paso del agua. Nuestro servicio permite recuperar el flujo adecuado y mantener el sistema funcionando correctamente."
    },
    {
      title: "Mantenimiento de planta de tratamiento",
      description:
        "Realizamos trabajos de limpieza, revisión y mantenimiento en sistemas de tratamiento de aguas, ayudando a conservar su funcionamiento adecuado y prevenir acumulaciones, obstrucciones o fallas en la operación."
    },
    {
      title: "Mantenimiento de instalaciones hidráulicas",
      description:
        "Brindamos mantenimiento preventivo y correctivo en tuberías y conexiones, ayudando a conservar el sistema en buenas condiciones y reducir el riesgo de filtraciones o daños futuros."
    },
    {
      title: "Reparación de tuberías",
      description:
        "Realizamos reparación y ajuste de tuberías para corregir fugas, conexiones dañadas y otros problemas que puedan afectar el funcionamiento adecuado de la instalación."
    }
  ];
  ...
  function metaFor(index) {
    return WORK_META[index] || {
      ...
      description:
        "Evidencia real de nuestros servicios técnicos ejecutados con personal especializado y equipo profesional."
    };
  }
  ...
  function syncLightbox() {
    ...
    if (detailNumber) {
      detailNumber.textContent =
        `TRABAJO ${String(activeIndex + 1).padStart(2, "0")} · SEPRIGUA`;
    }
